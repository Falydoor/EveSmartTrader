...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "EveSmartTrader@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "EveSmartTrader API";

        private String description = "EveSmartTrader API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "EveSmartTrader";
