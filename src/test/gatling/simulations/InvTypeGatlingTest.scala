...
/**
 * Performance test for the InvType entity.
 */
class InvTypeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvType entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created invType")
                .get("${new_invType_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invType")
            .delete("${new_invType_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
