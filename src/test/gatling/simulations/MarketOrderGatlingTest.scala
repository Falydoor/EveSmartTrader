...
/**
 * Performance test for the MarketOrder entity.
 */
class MarketOrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MarketOrder entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all marketOrders")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created marketOrder")
                .get("${new_marketOrder_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created marketOrder")
            .delete("${new_marketOrder_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
